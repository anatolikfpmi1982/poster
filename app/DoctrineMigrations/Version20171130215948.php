 ...
 */
class Version20171130215948 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE pictures ADD image_banner_id INT DEFAULT NULL, ADD image_module_id INT DEFAULT NULL, ADD image_frame_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE pictures DROP image_banner_id, DROP image_module_id, DROP image_frame_id');
    }
}
