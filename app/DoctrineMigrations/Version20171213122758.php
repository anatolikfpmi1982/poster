 ...
 */
class Version20171213122758 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE IF EXISTS parser_log');
        ...
        $this->addSql('CREATE TABLE parser_log (id INT AUTO_INCREMENT NOT NULL, message VARCHAR(255) DEFAULT NULL, file_date DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
